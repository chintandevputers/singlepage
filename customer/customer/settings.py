...
CORS_ALLOW_CREDENTIALS = (
    True  # Set to True to allow credentials (cookies, authorization headers)
)
CORS_ALLOW_HEADERS = ["Content-Type", "Authorization"]  # Customize allowed headers
...
DATABASES = {
    "default": {
        ...
        "NAME": "customer_data",  # Change this to your database name
        "USER": "postgres",  # Change this to your database user
        "PASSWORD": "ramramram",  # Change this to your database password
